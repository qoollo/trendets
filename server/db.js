...
function TrendetsDb(dbPath) {
    ...
    function defineModels(db) {
        ...
        var Quotes = db.define('Quotes', getColumnMapping({
            date: { type: 'date' },
            oil: { type: 'number' },
            usd: { type: 'number', mapsTo: 'USD' },
            eur: { type: 'number', mapsTo: 'EUR' },
        }));
